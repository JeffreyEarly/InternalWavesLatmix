filepath = '/Volumes/OceanTransfer/FloatsWithTemperatureProfileExperiment_2017-07-26T221153_256x64x32.nc';
x = ncread(filepath,'x-position-drifter')';
y = ncread(filepath,'y-position-drifter')';
z = ncread(filepath,'z-position-drifter')';
t = ncread(filepath,'t');
